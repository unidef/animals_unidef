...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rough-recipe-d37f
```

A live public deployment of this template is available at [https://rough-recipe-d37f.templates.workers.dev](https://rough-recipe-d37f.templates.workers.dev)
